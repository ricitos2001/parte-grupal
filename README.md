...
|Depurador|Su depurador es basico pero funcional||COMPLETO PARA C++|Su depurador es muy completo para Java y Kotlin|Completo para Python|
...
|Automatizacion de tareas|Permite la automatización de tareas mediante un archivo de configuracion||Si, uso de macros y herramientas externas para la automatización de tareas.|Las tareas se automatizan al ejecutar el programa|Sí (tests, compilación, etc.)|
|Soporte para multiples lenguajes|Soporta multiples lenguajes||Soporte nativo para c/c++, tambien aporta soportes esenciales para otros lenguajes|Soporta multiples lenguajes pero esta dedicado a Java y a Kotlin|Soporte principalmente para Python|
